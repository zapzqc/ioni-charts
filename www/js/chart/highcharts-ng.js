...
(function () {
  ...
  function highchart(highchartsNGUtils, $timeout) {
    ...
    var axisNames = [
        'xAxis',
        'yAxis',
       /* 'colorAxis',//添加属性支持heatmap变色,如果不需要，动态修改此属性，此处可以注释，使用option配置*/
       /* 'tooltip',//添加属性支持信息提示,如果不需要，动态修改此属性，此处可以注释，使用option配置*/
       /* 'legend'//添加属性支持,如果不需要，动态修改此属性，此处可以注释，使用option配置*/
      ];
